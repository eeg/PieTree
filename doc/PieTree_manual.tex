...
To use \PT, you will need the Cairo graphics library (\texttt{cairographics.org}; I used version 1.4.2), the Python programming language (\texttt{python.org}; I used version 2.5.1), the Python package for Cairo, and the Python module \texttt{configparse} (\texttt{gustaebel.de/lars/configparse/}).
...
Help, please.  
Maybe take a look at \texttt{kenkeiter.com/2007/11/21/compiling-cairo-and-pycairo-on-os-x/}
...
% TODO: note that radial looks best in pdf and svg
...
% TODO: shape = rect (default) or radial
...
\pagebreak
	...
	\item[height] The height of the canvas; doesn't affect the scaling of the image.
		...
		\end{valdescrip}
% TODO: notes for radial (default is width, otherwise cut off or whitespace)
	...
	\item[ymargin] The margin size on the top and bottom of the image.
		...
		\end{valdescrip}
% TODO: notes on margins for radial
